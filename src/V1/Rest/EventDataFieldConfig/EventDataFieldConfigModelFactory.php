<?php
	...
	/**  
	 * EventDataFieldConfigModelFactory object  
	 *  
	 * @file       EventDataFieldConfigModelFactory.php  
	 * @category   MicroIce
	 * @package    event data field config
...
class EventDataFieldConfigModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventDataFieldConfig\EventDataFieldConfigEntity');
        }
        else
        {
        	...
        	$model =  new EventDataFieldConfigModel($adapter);
