...
class EventProfilesTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventProfilesTypes\EventProfilesTypesEntity');
        }
        else
        {
        	...
        	$model =  new EventProfilesTypesModel($adapter);
