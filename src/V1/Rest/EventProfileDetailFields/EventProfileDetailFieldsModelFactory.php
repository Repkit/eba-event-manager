...
class EventProfileDetailFieldsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventProfileDetailFields\EventProfileDetailFieldsEntity');
        }
        else
        {
        	...
        	$model =  new EventProfileDetailFieldsModel($adapter);
