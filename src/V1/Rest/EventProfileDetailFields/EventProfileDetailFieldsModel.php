...
class EventProfileDetailFieldsModel extends Model
{
	protected $EntityClass 	= 'MicroIceEventManager\V1\Rest\EventProfileDetailFields\EventProfileDetailFieldsEntity';
	protected $TableName 	= 'event_profile_detail_fields';
