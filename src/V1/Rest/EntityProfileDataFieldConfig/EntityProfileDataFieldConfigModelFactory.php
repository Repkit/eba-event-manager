...
class EntityProfileDataFieldConfigModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfileDataFieldConfig\EntityProfileDataFieldConfigEntity');
        }
        else
        {
        	...
        	$model =  new EntityProfileDataFieldConfigModel($adapter);
