<?php
	...
	/**  
	 * EntityDetailsModelFactory object  
	 *  
	 * @file       EntityDetailsFactory.php  
	 * @category   MicroIce
...
class EntityDetailsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityDetails\EntityDetailsEntity');
        }
        else
        {
        	...
        	$model =  new EntityDetailsModel($adapter);
