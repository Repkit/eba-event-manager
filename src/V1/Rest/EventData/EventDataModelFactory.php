<?php
	...
	/**  
	 * EventDataModelFactory object  
	 *  
	 * @file       EventDataModelFactory.php  
	 * @category   MicroIce
	 * @package    event data
...
class EventDataModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventData\EventDataEntity');
        }
        else
        {
        	...
        	$model =  new EventDataModel($adapter);
