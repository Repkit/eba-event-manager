...
class EntityProfileDataFieldsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfileDataFields\EntityProfileDataFieldsEntity');
        }
        else
        {
        	...
        	$model =  new EntityProfileDataFieldsModel($adapter);
