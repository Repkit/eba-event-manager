<?php
	...
	/**  
	 * EntityDataModelFactory object  
	 *  
	 * @file       EntityDataModelFactory.php  
	 * @category   MicroIce
	 * @package    entity data
...
class EntityDataModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityData\EntityDataEntity');
        }
        else
        {
        	...
        	$model =  new EntityDataModel($adapter);
