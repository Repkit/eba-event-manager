...
class EntitiesDataResource extends AbstractResourceListener implements EventManagerAwareInterface
{
    ...
    public function create($data)
    {
        try 
        {
            $pTranslationId = $this->getEvent()->getRouteParam('entity_translation_id');
            ...
            $this->getEventManager()->trigger('entities_data.create.pre', $this, array());

            // create entity
            $entityClass = $this->_model->getEntityClass();
            $entity = new $entityClass();
            $entity->exchangeArray($rdata);
            $entity->EntityId = $pTranslationId;
            ...
            if(!$inserted){
                throw new \Exception("Could not associate entities data", 1);
            }
            $entity->Id = $this->_model->getLastInsertValue();

            $this->getEventManager()->trigger('entities_data.create.post', $this, array());
    ...
    public function delete($id)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('entities_data.delete.pre', $this, array());
            ...
            $this->getEventManager()->trigger('entities_data.delete.post', $this, array('id' => $id, 'adapter' => $this->_model->getAdapter(), 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
    ...
    public function fetch($id)
    {
        try 
        {
            ...
            $entity = $this->_model->getByEntityIdAndId($pTranslationId, $id);
    ...
    public function fetchAll($params = [])
    {
        try
        {
            ...
            $collection = $this->_model->getAllDataByEntityId($pTranslationId);

            return new EntitiessDataCollection(new \Zend\Paginator\Adapter\Iterator($collection));
        }
        catch(\InvalidArgumentException $e)
        {
            return new ApiProblem(400, $e->getMessage());
    ...
    public function update($id, $data)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('entities_data.update.pre', $this, array());
            ...
            $this->getEventManager()->trigger('entities_data.update.post', $this, array('id' => $id, 'data' => $data, 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
