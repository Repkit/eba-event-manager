<?php
	...
	/**  
	 * EntitiesDataModelFactory object  
	 *  
	 * @file       EntitiesDataModelFactory.php  
	 * @category   MicroIce
...
class EntitiesDataModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntitiesData\EntitiesDataEntity');
        }
        else
        {
        	...
        	$model =  new EntitiesDataModel($adapter);
