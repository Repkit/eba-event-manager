<?php
	...
	/**  
	 * EventDetailFieldsModelFactory object  
	 *  
	 * @file       EventDetailFieldsModelFactory.php  
	 * @category   MicroIce
	 * @package    event detail fields
...
class EventDetailFieldsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventDetailFields\EventDetailFieldsEntity');
        }
        else
        {
        	...
        	$model =  new EventDetailFieldsModel($adapter);
