<?php
	...
	/**  
	 * EventTypesModelFactory object  
	 *  
	 * @file       EventTypesModelFactory.php  
	 * @category   MicroIce
...
class EventTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventTypes\EventTypesEntity');
        }
        else
        {
        	...
        	$model =  new EventTypesModel($adapter);
