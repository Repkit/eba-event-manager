...
class EventTypeTranslationsResource extends AbstractResourceListener implements EventManagerAwareInterface
{
    ...
    public function delete($id)
    {
        ...
        {
            $deleted = false;
            $this->getEventManager()->trigger('event_type_translations.delete.pre', $this, array());
            ...
            $this->getEventManager()->trigger('event_type_translations.delete.post', $this, array('id' => $id, 'adapter' => $this->_model->getAdapter(), 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
    ...
    public function fetchAll($params = [])
    {
        try
        {
            ...
            return new EventTypeTranslationsCollection(new \Zend\Paginator\Adapter\Iterator($translations));
    ...
    public function patch($id, $data)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('event_type_translations.patch.pre', $this, array());
            ...
            $this->getEventManager()->trigger('event_type_translations.patch.post', $this, array('id' => $id, 'data' => $data, 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
    ...
    public function update($id, $data)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('event_type_translations.update.pre', $this, array());
            ...
            $this->getEventManager()->trigger('event_type_translations.update.post', $this, array('id' => $id, 'data' => $data, 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
