<?php
	...
	/**  
	 *EventTypeTranslationsModelFactory object  
	 *  
	 * @file       EventTypeTranslationsModelFactory.php  
	 * @category   MicroIce
	 * @package    event type translations
...
class EventTypeTranslationsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
            $model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventTypeTranslations\EventTypeTranslationsEntity');
        }
        else
        {
            ...
            $model =  new EventTypeTranslationsModel($adapter);
