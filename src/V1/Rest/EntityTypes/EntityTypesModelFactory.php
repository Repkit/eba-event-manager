<?php
	...
	/**  
	 * EntityTypesModelFactory object  
	 *  
	 * @file       EntityTypesModelFactory.php  
	 * @category   MicroIce
...
class EntityTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityTypes\EntityTypesEntity');
        }
        else
        {
        	...
        	$model =  new EntityTypesModel($adapter);
