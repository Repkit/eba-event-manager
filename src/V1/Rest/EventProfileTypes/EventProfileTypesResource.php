...
class EventProfileTypesResource extends AbstractResourceListener implements EventManagerAwareInterface
{
    ...
    public function create($data)
    {
        try
        {
            $this->getEventManager()->trigger('event_profile_types.create.pre', $this, array());

            $id = $this->getEvent()->getRouteParam('event_profile_types_id');
            ...
            if( $default )
            {
                ...
                if( !empty($rdata['Name']) )
                {
                    ...
                    if( !empty($texists) )
                    {
                        throw new \InvalidArgumentException("An event profile type with same name already exists!", 1);
                    }
                }
                ...
                if( !$inserted )
                {
                    throw new \Exception("Could not create event profile type", 1);
                }
            ...
            if( !$inserted )
            {
                throw new \Exception("Could not create event profile type translation", 2);
            }
            ...
            $this->getEventManager()->trigger('event_profile_types.create.post', $this, array('entity' => $entity, 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()));
    ...
    public function delete($id)
    {
        try
        {
            $this->getEventManager()->trigger('event_profile_types.delete.pre', $this, array());
            ...
            $this->getEventManager()->trigger('event_profile_types.delete.post', $this, array('id' => $id, 'adapter' => $this->_model->getAdapter(), 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()));
    ...
    public function fetch($id)
    {
        try
        {
            ...
            return new EventProfileTypesCollection(new \Zend\Paginator\Adapter\Iterator($profileTypes));
        }
        catch (\InvalidArgumentException $e)
        {
            return new ApiProblem(400, $e->getMessage());
    ...
    public function patch($id, $data)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('event_profile_types.patch.pre', $this, array());
            ...
            {
                // update translated event profile type
            ...
            $this->getEventManager()->trigger('event_profile_types.patch.post', $this, array('id' => $id, 'data' => $data, 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()));
    ...
    public function update($id, $data)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('event_profile_types.update.pre', $this, array());
            ...
            unset($updateData['Timestamp']);
            $this->_model->update($updateData, array('Id' => $id));
            $this->getEventManager()->trigger('event_profile_types.update.post', $this, array('id' => $id, 'data' => $data, 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()));
            $connection->commit();
