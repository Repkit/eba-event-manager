<?php
	...
	/**  
	 * EntityDataFieldConfigModelFactory object  
	 *  
	 * @file       EntityDataFieldConfigModelFactory.php  
	 * @category   MicroIce
	 * @package    entity data field config
...
class EntityDataFieldConfigModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityDataFieldConfig\EntityDataFieldConfigEntity');
        }
        else
        {
        	...
        	$model =  new EntityDataFieldConfigModel($adapter);
