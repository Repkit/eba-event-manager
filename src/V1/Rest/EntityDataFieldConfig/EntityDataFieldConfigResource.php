...
class EntityDataFieldConfigResource extends AbstractResourceListener implements EventManagerAwareInterface
{
    ...
    public function __construct(TableGatewayInterface $Model, TableGatewayInterface $DataType, TableGatewayInterface $EntityDataFields)
    {
        $this->_model = $Model;
    ...
    public function create($data)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('entity_data_field_config.create.pre', $this, array());

            $creationDate = date('Y-m-d H:i:s');
            $fieldcfg = new EntityDataFieldConfigEntity();
            ...
            $entityData = new \MicroIceEventManager\V1\Rest\EntityData\EntityDataEntity();
            ...
            $this->getEventManager()->trigger('entity_data_field_config.create.post', $this, array('entity' => $fieldcfg, 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
    ...
    public function delete($id)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('entity_data_field_config.delete.pre', $this, array());
            ...
            if(!$result){
                throw new \Exception("Error deleting configuration", 1);
            }

            // delete all field values from data fields
            $this->_entityDataFields->delete(array('Field' => $field));
            
            $this->getEventManager()->trigger('entity_data_field_config.delete.post', $this, array('id' => $id, 'adapter' => $this->_model->getAdapter(), 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
    ...
    public function fetchAll($params = array())
    {
        try
        {
            ...
            return new EntityDataFieldConfigCollection(new \Zend\Paginator\Adapter\Iterator($fields));
        }
        catch(\InvalidArgumentException $e)
        {
            return new ApiProblem(400, $e->getMessage());
    ...
    public function update($id, $data)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('entity_data_field_config.update.pre', $this, array());

            $field = new EntityDataFieldConfigEntity();
            ...
            $this->getEventManager()->trigger('entity_data_field_config.update.post', $this, array('id' => $id, 'data' => $data, 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
        ...
        // return new ApiProblem(405, 'The UPDATE method has not been defined for individual resources');
    }
}
