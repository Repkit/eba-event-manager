...
class EventProfileDataFieldsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventProfileDataFields\EventProfileDataFieldsEntity');
        }
        else
        {
        	...
        	$model =  new EventProfileDataFieldsModel($adapter);
