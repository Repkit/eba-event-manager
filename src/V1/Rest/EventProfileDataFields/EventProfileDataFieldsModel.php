...
class EventProfileDataFieldsModel extends Model
{
	protected $EntityClass 	= 'MicroIceEventManager\V1\Rest\EventProfileDataFields\EventProfileDataFieldsEntity';
	protected $TableName 	= 'event_profile_data_fields';
