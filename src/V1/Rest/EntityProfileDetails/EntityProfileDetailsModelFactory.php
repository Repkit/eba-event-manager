...
class EntityProfileDetailsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfileDetails\EntityProfileDetailsEntity');
        }
        else
        {
        	...
        	$model =  new EntityProfileDetailsModel($adapter);
