...
class EntityProfilesDataResource extends AbstractResourceListener implements EventManagerAwareInterface
{
    ...
    public function create($data)
    {
        try
        {
            $pTranslationId = $this->getEvent()->getRouteParam('entity_profile_translation_id');
            ...
            $this->getEventManager()->trigger('entity_profiles_data.create.pre', $this, array());
            ...
            if( !$inserted )
            {
                throw new \Exception("Could not associate entity profiles data", 1);
            }
            $entity->Id = $this->_model->getLastInsertValue();

            $this->getEventManager()->trigger('entity_profiles_data.create.post', $this, array());
    ...
    public function delete($id)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('entity_profiles_data.delete.pre', $this, array());
            ...
            $this->getEventManager()->trigger('entity_profiles_data.delete.post', $this, array('id' => $id, 'adapter' => $this->_model->getAdapter(), 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
    ...
    public function fetchAll($params = [])
    {
        try
        {
            ...
            return new EntityProfilesDataCollection(new \Zend\Paginator\Adapter\Iterator($collection));
        }
        catch(\InvalidArgumentException $e)
        {
            return new ApiProblem(400, $e->getMessage());
    ...
    public function update($id, $data)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('entity_profiles_data.update.pre', $this, array());
            ...
            $this->getEventManager()->trigger('entity_profiles_data.update.post', $this, array('id' => $id, 'data' => $data, 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
