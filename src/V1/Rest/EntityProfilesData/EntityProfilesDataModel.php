...
class EntityProfilesDataModel extends Model
{
	protected $EntityClass 	= 'MicroIceEventManager\V1\Rest\EntityProfilesData\EntityProfilesDataEntity';
	protected $TableName 	= 'entity_profiles_data';
