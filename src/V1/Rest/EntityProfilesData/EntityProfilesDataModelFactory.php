...
class EntityProfilesDataModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfilesData\EntityProfilesDataEntity');
        }
        else
        {
        	...
        	$model =  new EntityProfilesDataModel($adapter);
