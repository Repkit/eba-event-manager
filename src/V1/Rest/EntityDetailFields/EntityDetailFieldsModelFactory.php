<?php
	...
	/**  
	 * EntityDetailFieldsModelFactory object  
	 *  
	 * @file       EntityDetailFieldsModelFactory.php  
	 * @category   MicroIce
	 * @package    entity detail fields
...
class EntityDetailFieldsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityDetailFields\EntityDetailFieldsEntity');
        }
        else
        {
        	...
        	$model =  new EntityDetailFieldsModel($adapter);
