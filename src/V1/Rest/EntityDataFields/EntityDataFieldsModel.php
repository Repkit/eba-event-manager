...
class EntityDataFieldsModel extends Model
{
	protected $EntityClass 	= 'MicroIceEventManager\V1\Rest\EntityDataFields\EntityDataFieldsEntity';
	protected $TableName 	= 'entity_data_fields';
