<?php
	...
	/**  
	 * EntityDataFieldsModelFactory object  
	 *  
	 * @file       EntityDataFieldsModelFactory.php  
	 * @category   MicroIce
	 * @package    entity data fields
...
class EntityDataFieldsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityDataFields\EntityDataFieldsEntity');
        }
        else
        {
        	...
        	$model =  new EntityDataFieldsModel($adapter);
