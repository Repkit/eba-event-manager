...
class EventProfileTypeTranslationsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
            $model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventProfileTypeTranslations\EventProfileTypeTranslationsEntity');
        }
        else
        {
            ...
            $model =  new EventProfileTypeTranslationsModel($adapter);
