<?php
	...
	/**  
	 * EntityTypesDataTypesModelFactory object  
	 *  
	 * @file       EntityTypesDataTypesModelFactory.php  
	 * @category   MicroIce
	 * @package    entity_types_data_types
...
class EntityTypesDataTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityTypesDataTypes\EntityTypesDataTypesEntity');
        }
        else
        {
        	...
        	$model =  new EntityTypesDataTypesModel($adapter);
