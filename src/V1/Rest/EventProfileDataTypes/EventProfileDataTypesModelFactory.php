...
class EventProfileDataTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventProfileDataTypes\EventProfileDataTypesEntity');
        }
        else
        {
        	...
        	$model =  new EventProfileDataTypesModel($adapter);
