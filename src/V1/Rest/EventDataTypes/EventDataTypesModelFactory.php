<?php
	...
	/**  
	 * EventDataTypesModelFactory object  
	 *  
	 * @file       EventDataTypesModelFactory.php  
	 * @category   MicroIce
	 * @package    event data types
...
class EventDataTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventDataTypes\EventDataTypesEntity');
        }
        else
        {
        	...
        	$model =  new EventDataTypesModel($adapter);
