<?php
	...
	/**  
	 * EventDataFieldsModelFactory object  
	 *  
	 * @file       EventDataFieldsModelFactory.php  
	 * @category   MicroIce
	 * @package    event data fields
...
class EventDataFieldsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventDataFields\EventDataFieldsEntity');
        }
        else
        {
        	...
        	$model =  new EventDataFieldsModel($adapter);
