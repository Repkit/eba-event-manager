...
class EventDataFieldsModel extends Model
{
	protected $EntityClass 	= 'MicroIceEventManager\V1\Rest\EventDataFields\EventDataFieldsEntity';
	protected $TableName 	= 'event_data_fields';
