...
class EventProfileDataModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventProfileData\EventProfileDataEntity');
        }
        else
        {
        	...
        	$model =  new EventProfileDataModel($adapter);
