<?php
	...
	/**  
	 * EventsTypesModelFactory object  
	 *  
	 * @file       EventsTypesModelFactory.php  
	 * @category   MicroIce
...
class EventTypesDataTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventTypesDataTypes\EventTypesDataTypesEntity');
        }
        else
        {
        	...
        	$model =  new EventTypesDataTypesModel($adapter);
