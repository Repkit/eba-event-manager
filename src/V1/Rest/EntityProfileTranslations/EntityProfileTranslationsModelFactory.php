...
class EntityProfileTranslationsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
            $model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfileTranslations\EntityProfileTranslationsEntity');
        }
        else
        {
            ...
            $model =  new EntityProfileTranslationsModel($adapter);
