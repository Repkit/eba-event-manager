...
class EntityProfileTranslationsModel extends Model
{
	protected $EntityClass 	= 'MicroIceEventManager\V1\Rest\EntityProfileTranslations\EntityProfileTranslationsEntity';
	protected $TableName 	= 'entity_profile_translations';
