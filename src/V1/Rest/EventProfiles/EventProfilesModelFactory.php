<?php
	...
	/**  
	 * EventProfilesModelFactory object  
	 *  
	 * @file       EventProfilesModelFactory.php  
	 * @category   MicroIce
...
class EventProfilesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventProfiles\EventProfilesEntity');
        }
        else
        {
        	...
        	$model =  new EventProfilesModel($adapter);
