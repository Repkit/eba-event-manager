...
class EventProfileTranslationsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
            $model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventProfileTranslations\EventProfileTranslationsEntity');
        }
        else
        {
            ...
            $model =  new EventProfileTranslationsModel($adapter);
