...
class EventProfileDataFieldConfigResource extends AbstractResourceListener implements EventManagerAwareInterface
{
    ...
    public function create($data)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('event_profile_data_field_config.create.pre', $this, array());

            $creationDate = date('Y-m-d H:i:s');
            $fieldcfg = new EventProfileDataFieldConfigEntity();
            ...
            $eventData = new \MicroIceEventManager\V1\Rest\EventProfileData\EventProfileDataEntity();
            ...
            $this->getEventManager()->trigger('event_profile_data_field_config.create.post', $this, array('entity' => $fieldcfg, 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
    ...
    public function delete($id)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('event_profile_data_field_config.delete.pre', $this, array());
            ...
            $this->getEventManager()->trigger('event_profile_data_field_config.delete.post', $this, array('id' => $id, 'adapter' => $this->_model->getAdapter(), 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
    ...
    public function fetchAll($params = [])
    {
        try
        {
            ...
            return new EventProfileDataFieldConfigCollection(new \Zend\Paginator\Adapter\Iterator($fields));
        }
        catch(\InvalidArgumentException $e)
        {
            return new ApiProblem(400, $e->getMessage());
    ...
    public function update($id, $data)
    {
        try
        {
            ...
            if( !$type || $type->Status != 1 )
            {
                throw new \InvalidArgumentException("Please specify a valid event data profile type!", 1);
            }
            $typeId = $type->Id;
            unset($type);

            $this->getEventManager()->trigger('event_profile_data_field_config.update.pre', $this, array());

            $field = new EventProfileDataFieldConfigEntity();
            ...
            $this->getEventManager()->trigger('event_profile_data_field_config.update.post', $this, array('id' => $id, 'data' => $data, 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
