...
class EventProfileDataFieldConfigModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventProfileDataFieldConfig\EventProfileDataFieldConfigEntity');
        }
        else
        {
        	...
        	$model =  new EventProfileDataFieldConfigModel($adapter);
