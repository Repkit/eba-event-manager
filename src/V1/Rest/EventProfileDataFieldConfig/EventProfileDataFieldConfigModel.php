...
class EventProfileDataFieldConfigModel extends Model
{
	protected $EntityClass 	= 'MicroIceEventManager\V1\Rest\EventProfileDataFieldConfig\EventProfileDataFieldConfigEntity';
	protected $TableName 	= 'event_profile_data_field_config';
