...
class EventProfileDataPreferencesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventProfileDataPreferences\EventProfileDataPreferencesEntity');
        }
        else
        {
        	...
        	$model =  new EventProfileDataPreferencesModel($adapter);
