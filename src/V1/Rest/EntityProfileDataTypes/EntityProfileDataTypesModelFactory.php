...
class EntityProfileDataTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfileDataTypes\EntityProfileDataTypesEntity');
        }
        else
        {
        	...
        	$model =  new EntityProfileDataTypesModel($adapter);
