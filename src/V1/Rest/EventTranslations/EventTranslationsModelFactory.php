<?php
	...
	/**  
	 * EventTranslationsModelFactory object  
	 *  
	 * @file       EventTranslationsModelFactory.php  
	 * @category   MicroIce
	 * @package    event translations
...
class EventTranslationsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventTranslations\EventTranslationsEntity');
        }
        else
        {
        	...
        	$model =  new EventTranslationsModel($adapter);
