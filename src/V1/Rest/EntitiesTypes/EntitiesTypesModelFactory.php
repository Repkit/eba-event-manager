<?php
	...
	/**  
	 * EntitiesTypesModelFactory object  
	 *  
	 * @file       EntitiesTypeModelFactory.php  
	 * @category   MicroIce
...
class EntitiesTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntitiesTypes\EntitiesTypesEntity');
        }
        else
        {
        	...
        	$model =  new EntitiesTypesModel($adapter);
