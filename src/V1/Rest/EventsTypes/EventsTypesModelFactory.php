...
class EventsTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventsTypes\EventsTypesEntity');
        }
        else
        {
        	...
        	$model =  new EventsTypesModel($adapter);
