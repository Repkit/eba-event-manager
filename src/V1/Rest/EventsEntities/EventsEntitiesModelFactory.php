<?php
	...
	/**  
	 * EventsEntitiesModelFactory object  
	 *  
	 * @file       EventsEntitiesModelFactory.php  
	 * @category   MicroIce
...
class EventsEntitiesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventsEntities\EventsEntitiesEntity');
        }
        else
        {
        	...
        	$model =  new EventsEntitiesModel($adapter);
