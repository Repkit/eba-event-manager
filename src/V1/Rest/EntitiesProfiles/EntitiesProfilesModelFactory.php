<?php
	...
	/**  
	 * EntitiesProfilesModelFactory object  
	 *  
	 * @file       EntitiesProfilesModelFactory.php  
	 * @category   MicroIce
...
class EntitiesProfilesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntitiesProfiles\EntitiesProfilesEntity');
        }
        else
        {
        	...
        	$model =  new EntitiesProfilesModel($adapter);
