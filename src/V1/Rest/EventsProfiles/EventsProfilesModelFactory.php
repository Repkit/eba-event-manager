<?php
	...
	/**  
	 * EventsProfilesModelFactory object  
	 *  
	 * @file       EventsProfilesModelFactory.php  
	 * @category   MicroIce
...
class EventsProfilesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventsProfiles\EventsProfilesEntity');
        }
        else
        {
        	...
        	$model =  new EventsProfilesModel($adapter);
