<?php
	...
	/**  
	 * EntitiesModelFactory object  
	 *  
	 * @file       EntitiesModelFactory.php  
	 * @category   MicroIce
...
class EntitiesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\Entities\EntitiesEntity');
        }
        else
        {
        	...
        	$model =  new EntitiesModel($adapter);
