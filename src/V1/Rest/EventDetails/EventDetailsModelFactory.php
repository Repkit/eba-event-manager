<?php
	...
	/**  
	 * EventDetailsModelFactory object  
	 *  
	 * @file       EventDetailsFactory.php  
	 * @category   MicroIce
...
class EventDetailsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventDetails\EventDetailsEntity');
        }
        else
        {
        	...
        	$model =  new EventDetailsModel($adapter);
