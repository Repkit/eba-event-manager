...
class EntityProfilesTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfilesTypes\EntityProfilesTypesEntity');
        }
        else
        {
        	...
        	$model =  new EntityProfilesTypesModel($adapter);
