...
class EntityProfileTypesDataTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfileTypesDataTypes\EntityProfileTypesDataTypesEntity');
        }
        else
        {
        	...
        	$model =  new EntityProfileTypesDataTypesModel($adapter);
