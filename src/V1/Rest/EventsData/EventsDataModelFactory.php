<?php
	...
	/**  
	 * EventsDataModelFactory object  
	 *  
	 * @file       EventsDataModelFactory.php  
	 * @category   MicroIce
...
class EventsDataModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventsData\EventsDataEntity');
        }
        else
        {
        	...
        	$model =  new EventsDataModel($adapter);
