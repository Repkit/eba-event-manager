<?php
	...
	/**  
	 * EventsModelFactory object  
	 *  
	 * @file       EventsModelFactory.php  
	 * @category   MicroIce
...
class EventsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\Events\EventsEntity');
        }
        else
        {
