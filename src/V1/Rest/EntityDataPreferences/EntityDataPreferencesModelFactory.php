<?php
	...
	/**  
	 * EntityDataPreferencesModelFactory object  
	 *  
	 * @file       EntityDataPreferencesFactory.php  
	 * @category   MicroIce
	 * @package    entity data preferences
...
class EntityDataPreferencesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityDataPreferences\EntityDataPreferencesEntity');
        }
        else
        {
        	...
        	$model =  new EntityDataPreferencesModel($adapter);
