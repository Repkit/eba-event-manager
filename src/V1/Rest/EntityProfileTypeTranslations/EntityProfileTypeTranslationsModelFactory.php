...
class EntityProfileTypeTranslationsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
            $model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfileTypeTranslations\EntityProfileTypeTranslationsEntity');
        }
        else
        {
            ...
            $model =  new EntityProfileTypeTranslationsModel($adapter);
