...
class EntityProfileTypeTranslationsModel extends Model
{
	protected $EntityClass 	= 'MicroIceEventManager\V1\Rest\EntityProfileTypeTranslations\EntityProfileTypeTranslationsEntity';
	protected $TableName 	= 'entity_profile_type_translations';
