...
class EventProfileDetailsModel extends Model
{
	protected $EntityClass 	= 'MicroIceEventManager\V1\Rest\EventProfileDetails\EventProfileDetailsEntity';
	protected $TableName 	= 'event_profile_details';
