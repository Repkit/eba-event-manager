...
class EntityProfileDetailFieldsResource extends AbstractResourceListener implements EventManagerAwareInterface
{
    ...
    public function create($data)
    {
        try
        {
            ...
            $profileType = $this->getEvent()->getRouteParam('entity_profile_type_id');
            if( !isset($profileType) || empty($profileType) )
            {
                throw new \InvalidArgumentException("Please specify a type for the entity profile!", 1);
            }
            ...
            $this->getEventManager()->trigger('entity_profile_detail_fields.create.pre', $this, array());

            $creationDate = date('Y-m-d H:i:s');

            $fieldcfg = new EntityProfileDetailFieldsEntity();
            ...
            $entityProfile = new \MicroIceEventManager\V1\Rest\EntityProfiles\EntityProfilesEntity();
            $predefinedFields = $entityProfile->toArray();
            ...
            $this->getEventManager()->trigger('entity_profile_detail_fields.create.post', $this, array('entity' => $fieldcfg, 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
    ...
    public function delete($id)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('entity_profile_detail_fields.delete.pre', $this, array());
            ...
            $this->getEventManager()->trigger('entity_profile_detail_fields.delete.post', $this, array('id' => $id, 'adapter' => $this->_model->getAdapter(), 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
            $connection->commit();
            return (bool)$result;
        }
        catch(\InvalidArgumentException $e)
    ...
    public function fetchAll($params = array())
    {
        try
        {
            ...
            return new EntityProfileDetailFieldsCollection(new \Zend\Paginator\Adapter\Iterator($fields));
        }
        catch(\InvalidArgumentException $e)
        {
            return new ApiProblem(400, $e->getMessage());
    ...
    public function update($id, $data)
    {
        try
        {
            ...
            $this->getEventManager()->trigger('entity_profile_detail_fields.update.pre', $this, array());

            $field = new EntityProfileDetailFieldsEntity();
            ...
            $this->getEventManager()->trigger('entity_profile_detail_fields.update.post', $this, array('id' => $id, 'data' => $data, 'routeParams' => $this->getEvent()->getRouteMatch()->getParams()) );
