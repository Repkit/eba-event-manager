...
class EntityProfileDetailFieldsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfileDetailFields\EntityProfileDetailFieldsEntity');
        }
        else
        {
        	...
        	$model =  new EntityProfileDetailFieldsModel($adapter);
