...
class EntityProfilesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfiles\EntityProfilesEntity');
        }
        else
        {
        	...
        	$model =  new EntityProfilesModel($adapter);
