...
class EntityProfileTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfileTypes\EntityProfileTypesEntity');
        }
        else
        {
        	...
        	$model =  new EntityProfileTypesModel($adapter);
