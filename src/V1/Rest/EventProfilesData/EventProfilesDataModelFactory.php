...
class EventProfilesDataModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventProfilesData\EventProfilesDataEntity');
        }
        else
        {
        	...
        	$model =  new EventProfilesDataModel($adapter);
