...
class EntityProfilePreferencesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfilePreferences\EntityProfilePreferencesEntity');
        }
        else
        {
        	...
        	$model =  new EntityProfilePreferencesModel($adapter);
