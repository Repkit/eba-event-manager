...
class EntityProfileDataPreferencesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityProfileDataPreferences\EntityProfileDataPreferencesEntity');
        }
        else
        {
        	...
        	$model =  new EntityProfileDataPreferencesModel($adapter);
