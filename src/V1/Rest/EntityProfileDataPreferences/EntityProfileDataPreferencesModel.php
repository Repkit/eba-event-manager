...
class EntityProfileDataPreferencesModel extends Model
{
	protected $EntityClass 	= 'MicroIceEventManager\V1\Rest\EntityProfileDataPreferences\EntityProfileDataPreferencesEntity';
	protected $TableName 	= 'entity_profile_data_preferences';
