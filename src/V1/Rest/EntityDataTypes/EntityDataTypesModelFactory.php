<?php
	...
	/**  
	 * EntityDataTypesModelFactory object  
	 *  
	 * @file       EntityDataTypesModelFactory.php  
	 * @category   MicroIce
	 * @package    entity data types
...
class EntityDataTypesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityDataTypes\EntityDataTypesEntity');
        }
        else
        {
        	...
        	$model =  new EntityDataTypesModel($adapter);
