<?php
	...
	/**  
	 *EntityTranslationsModelFactory object  
	 *  
	 * @file       EntityTranslationsModelFactory.php  
	 * @category   MicroIce
	 * @package    entity translations
...
class EntityTranslationsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
            $model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityTranslations\EntityTranslationsEntity');
        }
        else
        {
            ...
            $model =  new EntityTranslationsModel($adapter);
