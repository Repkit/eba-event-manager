...
class EntityTypeTranslationsModel extends Model
{
	protected $EntityClass 	= 'MicroIceEventManager\V1\Rest\EntityTypeTranslations\EntityTypeTranslationsEntity';
	protected $TableName 	= 'entity_type_translations';
