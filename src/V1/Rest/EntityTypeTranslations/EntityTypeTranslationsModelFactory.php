<?php
	...
	/**  
	 *EntityTypeTranslationsModelFactory object  
	 *  
	 * @file       EntityTypeTranslationsModelFactory.php  
	 * @category   MicroIce
	 * @package    entity type translations
...
class EntityTypeTranslationsModelFactory
{
	public function __invoke($services)
    {
        ...
        {
            $model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EntityTypeTranslations\EntityTypeTranslationsEntity');
        }
        else
        {
            ...
            $model =  new EntityTypeTranslationsModel($adapter);
