<?php
	...
	/**  
	 * EventProfilePreferencesModelFactory object  
	 *  
	 * @file       EventProfilePreferencesFactory.php  
	 * @category   MicroIce
...
class EventProfilePreferencesModelFactory
{
	public function __invoke($services)
    {
        ...
        {
        	$model = $services->get('DbManager')->get('MicroIceEventManager\V1\Rest\EventProfilePreferences\EventProfilePreferencesEntity');
        }
        else
        {
        	...
        	$model =  new EventProfilePreferencesModel($adapter);
