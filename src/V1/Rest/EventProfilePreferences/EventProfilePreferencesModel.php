...
class EventProfilePreferencesModel extends Model
{
	protected $EntityClass 	= 'MicroIceEventManager\V1\Rest\EventProfilePreferences\EventProfilePreferencesEntity';
	protected $TableName 	= 'event_profile_preferences';
